...
- 40% Follow up:
	...
	- 了解 [[环丙氨嗪]] 的尺寸信息
	- [[CURIA]] 视频会议，由Jason发起，与印度采购Sanjib联系: DCPD Production plan. key raw material; Introduce our company. 日出销售额 2.8billion usd this year
		- 磷酸三钾是CURIA工厂常规项目。
			- 用量预估：2022-2023年，预计采购15-20吨/年；之后可能会放大到25-40吨/年。
			- 技术指标关键：Bulk density; particle size; water content: LOD。Sanjib表示可以会后发邮件给我们。
		- DCPD:
			- 6吨订单：数量不变（如有变化会提前告知）。客户生产计划排到6月，希望到货时间是5月份。争取PO 12月前先发过来，提前安排生产，避免风险。
			- 包装：全纸桶不牢固；可否使用SDPE桶。
			- 其他信息：终端在Kyoto，需要等他们消息
